...
class ServiceModel
{
    ...
    public function __construct()
    {
        ...
        $paths = array(MAIN_DIR . '/Salesloft/Models/');
        $isDevMode = false;
        ...
        $dbParams = array(
                'driver'     => 'pdo_mysql',
                'host'         => $db_config['salesloft']['host'],
                'user'         => $db_config['salesloft']['user'],
                'password' => $db_config['salesloft']['pass'],
                'dbname'     => $db_config['salesloft']['db'],
        );
